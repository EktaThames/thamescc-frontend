        ...
        <div className="lg:w-2/3 overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="mt-6 flex items-center gap-3">
              <button
                onClick={prev}
                className="bg-orange-500 text-white rounded p-3 shadow hover:bg-orange-700 cursor-pointer"
              >
            ...
            <div className="flex justify-center mt-6 gap-2">
              {groupedReviews.map((_, i) => (
                <div
                  key={i}
                  className={`w-3 h-3 rounded-full cursor-pointer ${index === i ? 'bg-orange-500' : 'bg-orange-50'
                    }`}
                  onClick={() => setIndex(i)}
                ></div>
              ))}
